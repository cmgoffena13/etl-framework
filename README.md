...
```
**IMPORTANT** - The final deprecation completely removes all the data associated. The information removed is the PipelineIDs found in the etl.DeprecationDeclared table and all of the audit logs, run time logs, etc. for those pipelines. Finally, the address and ALL DATA in the table address is removed.  
...
### etl.Pipeline_UI
The etl.Pipeline_UI stored procedure is used to manually create pipeline and input PipelineArgs at creation. Below are the inputs:
 - @PipelineName VARCHAR(150) - **Required**
    - Pipeline Identifier Ex. 'SourceDatabase.SourceSchema.SourceTable Extraction'
    - Must be unique
 - @PipelineType VARCHAR(150) - **Required**
